...
public final class Temperature extends View {
	...
	private static final int centerDegree = 5000; // the one in the top center (12 o'clock)
	...
	private void initDrawingTools() {
		...
		titlePaint.setColor(0xaff0f010);
	...
	private Runnable mUpdateTimeTask = new Runnable() {
		public synchronized void run() {
		    ...
		    long millis = System.currentTimeMillis() - start;
		       ...
		       int mph = (((DashApplication) myApp).getKph() / 8) * 5;
		       ...
		       {
		    	   if (seconds < 10) {
		    		   mTitle.setText("" + minutes + ":0" + seconds);
		    	   } else {
		    		   mTitle.setText("" + minutes + ":" + seconds);            
		    	   }
		       }
		       else
		       {
